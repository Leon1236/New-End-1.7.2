...
public class BlockEndUraniumOre extends Block {
	...
	public BlockEndUraniumOre(Material p_i45394_1_) {
			...
			this.setBlockName(Strings.BlockEndUraniumOre_NAME); //name of the block in texture folder
			this.setBlockTextureName(References.MOD_ID + ":BlockEndUraniumOre"); //sets texture for your block
	}
