...
public class BlockEndBronzeOre extends Block {
	...
	public BlockEndBronzeOre(int id, Material p_i45394_1_) {
			...
			this.setBlockName(Strings.BlockEndBronzeOre_NAME); //name of the block in texture folder
			this.setBlockTextureName(References.MOD_ID + ":BlockEndBronzeOre"); //sets texture for your block
			}
